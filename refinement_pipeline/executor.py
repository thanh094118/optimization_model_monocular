...
def _load_external_modules(external_repo_root):
    ...
    from refinement_pipeline.utils import utils_optim as ut
    from refinement_pipeline.utils.optimization_formulations import OptimizeExtrinsics, OptimizePose
    from refinement_pipeline.utils.utils_activity_classification import predict_activity_from_video
    from refinement_pipeline.utils.utilsCameraPy3 import rotateIntrinsics, getVideoRotation
    from refinement_pipeline.utils.utilsChecker import detectGait
...
def run_refinement_optimization(config):
    ...
    external = _load_external_modules(cfg.get("external_repo_root", "refinement"))
    ...
    return run_optimization_only(
        ...
        output_dir=paths_cfg.get("refinement_output_dir", "output/refinement_results"),
